...
Renderer.prototype.render = function(fileName,callback) {
  ...
  try{
    ...
    console.log(this.lonlat2meters(data.bbox[0],data.bbox[1],data.bbox[2],data.bbox[3]));
...
Renderer.prototype.renderPolygon = function(coordinates,tags,contour){
  var style = this._style('Polygon',tags,this._zoom),
      i,
      j,
      x,
      y,
